...
== Changelog ==
= 1.0.4 - 2026-09-25 =
* SECURITY: Add On downloads from the license server no longer skip SSL verification, and Add On and theme downloads are now always requested over HTTPS. #20 (@dparker1005, @kta1kri)
* DEPRECATED: Deprecated `PMProUM_AddOns::http_request_args_for_addons()`, which no longer changes request arguments. #20 (@dparker1005)
